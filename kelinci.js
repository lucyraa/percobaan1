...
const itemData = {
    hair: [
        { name: "Long", price: 30, image: "long kelinci.png" },
        { name: "Curly", price: 30, image: "curly kelinci.png" },
        { name: "Short", price: 30, image: "short kelinci.png" }
    ],
    accessories: [
        { name: "Syal", price: 30, image: "syal kelinci.png" }, // Pastikan nama file benar
        { name: "Hat", price: 30, image: "hat kelinci.png" },
        { name: "Necklace", price: 30, image: "kalung kelinci.png" }
    ],
    playTools: [
