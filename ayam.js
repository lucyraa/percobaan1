...
const itemData = {
    hair: [
        { name: "Long", price: 30, image: "long ayam.png" },
        { name: "Curly", price: 30, image: "curly ayam.png" },
        { name: "Short", price: 30, image: "short ayam.png" }
    ],
    accessories: [
        { name: "Syal", price: 30, image: "syal ayam.png" },
        { name: "Topi", price: 30, image: "hat ayam.png" },
        { name: "Kalung", price: 30, image: "kalung ayam.png" }
    ],
    playTools: [
